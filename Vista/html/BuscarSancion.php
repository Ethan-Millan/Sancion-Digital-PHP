    ...
    <script>
        function redirigir(destino){
            if(destino === 'ConsultaGeneralSancion'){
                window.location.href = '../../Controlador/Controlador.php?accion=ConsultaGeneralSancion';
            }
        }
    </script>
</head>
<body>
    ...
    <h1>Plataforma Digital para la Gestión de Incidencias en Instituciones de Educación Superior</h1>
        <nav class="navbar">
            <ul>
                <li><a href="../../Controlador/Controlador.php?accion=Redireccion&accion2=GestionSancion"><img src="../img/Regresar.png" alt=""></a></li>
            </ul>
        </nav>
    </header> 
    
    <div class="formularios">
    <input type="button" value="Busqueda General" onclick="redirigir('ConsultaGeneralSancion')">
    <form action="../../Controlador/Controlador.php" method = 'post'>
        <input type="hidden" name="accion" value = "BuscarSancioMatricula" >
    ...
    <form action="../../Controlador/Controlador.php" method = 'post'>
        <input type="hidden" name = 'accion' value = "BuscarSacionFecha">
    ...
    <form action="../../Controlador/Controlador.php" method = 'post'>
        <input type="hidden" name="accion" value = 'BuscarPorPago'>
        <label>Pagado</label>
        <div class="Pagado">
    ...
    <form action="../../Controlador/Controlador.php" method = 'post'>
        <input type="hidden" name="accion" value = 'BuscarTipoMulta'>
        ...
        <?php
                if (!empty($consultas)) {
                    foreach ($consultas as $consulta) { // Itera sobre el array de consultas
                        ...
                        echo "<td>" . "<a href='../../Controlador/Controlador.php?accion=ModificarSancionView&idM=" . urlencode(htmlspecialchars($consulta['idM'])) . "'>" . "<img src='../img/modificar.png'>" . "</a>" . "</td>";
                        echo "<td>" . "<a href='../../Controlador/Controlador.php?accion=EliminarSancion&idM=" . urlencode(htmlspecialchars($consulta['idM'])) . "'>" . "<img src='../img/delete.png'>" . "</a>" . "</td>";
                        echo "</tr>";
                    }
