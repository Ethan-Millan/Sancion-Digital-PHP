    ...
    <script>
        function redirigir(destino){
            if(destino === 'RegistrarSanción'){
                window.location.href = '../../Controlador/Controlador.php?accion=Redireccion&accion2=RegistrarSancionV';
            }else if(destino === 'EliminarSanción'){
                window.location.href = '../../Controlador/Controlador.php?accion=Redireccion&accion2=BuscarSancionV';
            }
        }
    </script>
</head>
<body>
    ...
    <h1>Plataforma Digital para la Gestión de Incidencias en Instituciones de Educación Superior</h1>
                <nav class="navbar">
                    <ul>
                        <li><a href="../../Controlador/Controlador.php?accion=Redireccion&accion2=RegresarVigilante"><img src="../img/Regresar.png" alt=""></a></li>
                    </ul>
