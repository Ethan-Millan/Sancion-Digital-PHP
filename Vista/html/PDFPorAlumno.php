...
/* Evitar salto de página dentro de la firma */
footer .firma {
    page-break-inside: avoid; /* Evita que la firma se divida entre páginas */
}
...
<div class="pdf-preview">
    ...
    <div class="multa">
        <h4>Este alumno tuvo un total de <?php echo $totalMultas; ?> multas</h4>
    </div>
